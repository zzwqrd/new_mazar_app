                ...
                CustomButtonWidget(
                  ...
                  onPressed: () {
                    ...
                    if (inputAmountController.text.isEmpty) {
                      ...
                      String tokenUrl =
                          '${convert.base64Encode(convert.utf8.encode(ResponsiveHelper.isWeb() ? webUrl : url))}&&payment_platform=${kIsWeb ? 'web' : 'app'}&&is_add_fund=1';
                      String selectedUrl =
                      ...
                      if (kIsWeb) {
                        ...
                        Navigator.pushReplacementNamed(context,
                            RouteHelper.getPaymentRoute(url: selectedUrl));
                      }
                    }
                  },
                ),
