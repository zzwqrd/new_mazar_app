...
import 'package:mazar/common/widgets/title_widget.dart';
...
import 'package:mazar/features/wallet_and_loyalty/widgets/convert_money_widget.dart';
import 'package:mazar/features/wallet_and_loyalty/widgets/history_widget.dart';
import 'package:mazar/features/wallet_and_loyalty/widgets/tab_button_widget.dart';
...
class _LoyaltyScreenState extends State<LoyaltyScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      ...
      walletProvide.getLoyaltyTransactionList('1', false, false,
      ...
      child: Scaffold(
        ...
        body: Consumer<ProfileProvider>(builder: (context, profileProvider, _) {
          return configModel.loyaltyPointStatus!
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          walletProvider.transactionList != null
                                                                              ? walletProvider.transactionList!.isNotEmpty
                                                                                  ...
                                                                                  : NoDataWidget(isFooter: false, title: getTranslated('no_result_found', context))
              ...
              : NoDataWidget(title: getTranslated('no_result_found', context));
        }),
      ),
    );
  }
