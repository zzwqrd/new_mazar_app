...
class ProductReviewWidget extends StatelessWidget {
  ...
  const ProductReviewWidget({Key? key, required this.reviewModel})
      : super(key: key);
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ClipOval(
            ...
            image:
                '${splashProvider.baseUrls?.customerImageUrl}/${reviewModel.customer?.image ?? ''}',
            height: 50,
            width: 50,
            fit: BoxFit.cover,
          )),
          ...
          Expanded(
            child:
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                if (reviewModel.createdAt != null)
                  Text(DateConverterHelper.getDateToDateDifference(
              ...
              Row(children: [
                const Icon(Icons.star_rounded,
                    color: ColorResources.ratingColor, size: 20),
                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
