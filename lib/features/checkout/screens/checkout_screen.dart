...
import 'package:mazar/common/widgets/custom_app_bar_widget.dart';
...
import 'package:mazar/common/widgets/custom_single_child_list_widget.dart';
...
import 'package:mazar/features/checkout/widgets/delivery_address_widget.dart';
import 'package:mazar/features/checkout/widgets/details_widget.dart';
import 'package:mazar/features/checkout/widgets/place_order_button_widget.dart';
...
import 'package:mazar/helper/date_converter_helper.dart';
      ...
      body: isRoute
          ? Column(children: [
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Row(
                                                                  children: [
                                                                    ...
                                                                    Tooltip(
                                                                      triggerMode: ResponsiveHelper.isDesktop(
                                                                              context)
                                                                          ? null
                                                                          : TooltipTriggerMode
                                                                              .tap,
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Container(
                                                                            padding:
                                                                                const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall, horizontal: Dimensions.paddingSizeSmall),
                                                                            alignment:
                                                                                Alignment.center,
                                                                            decoration:
                                                                                BoxDecoration(
              ...
              if (!ResponsiveHelper.isDesktop(context))
                const Center(child: PlaceOrderButtonWidget()),
            ])
