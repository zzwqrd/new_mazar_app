      ...
      return orderProvider.trackModel != null &&
          ...
          ? Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                CustomDirectionalityWidget(
                  ...
                  PriceConverterHelper.convertPrice(
                      context, orderProvider.trackModel!.orderAmount),
                    ...
                    Padding(
                      ...
                      child: CustomPaint(
                        ...
                        painter: DashedLineVerticalPainter(
                            isActive: false, axis: Axis.horizontal),
                      ),
                    ),
                  if (OrderHelper.isShowDeliveryAddress(
                      orderProvider.trackModel))
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if (!isOrderFailed)
                  Consumer<LocationProvider>(
                    ...
                    return CustomStepperWidget(
                      ...
                      isComplete: status == OrderConstants.outForDelivery ||
                          status == OrderConstants.delivered,
                      statusImage: Images.outForDelivery,
                      isActive: status == OrderConstants.outForDelivery,
                      subTitleWidget: status == OrderConstants.outForDelivery
                          ? Text(
                              getTranslated(
                                  'your_delivery_man_is_coming', context),
                              style: poppinsRegular.copyWith(
                                  color: Theme.of(context).disabledColor,
                                  fontSize: Dimensions.fontSizeSmall),
                            )
                ...
                CustomStepperWidget(
                  height:
                      orderProvider.trackModel?.deliveryMan == null ? 30 : 130,
