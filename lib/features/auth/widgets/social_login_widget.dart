...
import 'package:mazar/features/auth/domain/models/social_login_model.dart';
import 'package:mazar/features/auth/providers/auth_provider.dart';
import 'package:mazar/features/auth/widgets/media_button_view.dart';
...
class SocialLoginWidget extends StatefulWidget {
  ...
  const SocialLoginWidget({Key? key, required this.countryCode})
      : super(key: key);
    ...
    return Consumer<AuthProvider>(builder: (context, authProvider, _) {
      return Column(children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          if (configModel?.socialLoginStatus?.isGoogle ?? false)
            Padding(
          ...
          if (configModel?.socialLoginStatus?.isFacebook ?? false)
            MediaButtonView(
          ...
          if (!kIsWeb &&
              ...
              (configModel?.appleLogin?.status ?? false))
            Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal: Dimensions.paddingSizeSmall),
              child: MediaButtonView(
