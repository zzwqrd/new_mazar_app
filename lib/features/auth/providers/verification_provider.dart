...
import 'package:mazar/features/auth/domain/models/signup_model.dart';
import 'package:mazar/features/auth/domain/reposotories/auth_repo.dart';
import 'package:mazar/features/auth/providers/auth_provider.dart' as auth;
...
class VerificationProvider with ChangeNotifier {
  ...
  Future<void> sendVerificationCode(
      ConfigModel config, SignUpModel signUpModel) async {
  ...
  Future<ResponseModel> verifyPhone(String phone) async {
    final auth.AuthProvider authProvider =
        Provider.of<auth.AuthProvider>(Get.context!, listen: false);
  ...
  void updateVerificationCode(String query, int queryLen,
      {bool isUpdate = true}) {
