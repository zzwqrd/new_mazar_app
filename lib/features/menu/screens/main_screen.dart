...
import 'package:mazar/common/widgets/custom_pop_scope_widget.dart';
...
import 'package:mazar/features/menu/domain/models/main_screen_model.dart';
...
List<MainScreenModel> screenListA = [
  MainScreenModel(const HomeScreen(), 'home', Images.home),
  MainScreenModel(const AllCategoriesScreen(), 'all_categories', Images.list),
  MainScreenModel(const CartScreen(), 'shopping_bag', Images.orderBag),
  MainScreenModel(const WishListScreen(), 'favourite', Images.favouriteIcon),
...
class CustomDrawer extends StatelessWidget {
  ...
  final List<MainScreenModel> screenList;
  final Function(int) onItemTap; // دالة لاستدعاء التنقل عند اختيار عنصر
